...
class Modeling():
    r"""
    a class for the modeling of the 3d density matter distribution for nfw profile
    """
    def __init__(self, M, concentration, cluster_z, background_density, delta, cosmo):
        ...
        background_density: str
            background density definition (mean or critical)
        delta: float
            overdensity (ex:: 200, 500, etc)
